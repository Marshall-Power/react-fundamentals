...
I learnt that React.createElement accepts 3 parameters, the type of element it creates, the props like "id, className" and the children who can in their turn be React.CreateElement

React.render renders the tree, only needs to be done once
